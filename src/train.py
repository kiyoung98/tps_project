...
parser.add_argument('--start_temperature', default=700, type=float, help='Initial temperature of annealing schedule')
parser.add_argument('--end_temperature', default=700, type=float, help='Final temperature of annealing schedule')
