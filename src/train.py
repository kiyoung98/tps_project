...
parser.add_argument('--num_samples', default=32, type=int, help='Number of paths to sample')
...
parser.add_argument('--num_rollouts', default=1000, type=int, help='Number of rollouts (or sampling)')
parser.add_argument('--trains_per_rollout', default=1, type=int, help='Number of training per rollout in a rollout')
parser.add_argument('--buffer_size', default=4096, type=int, help='Size of buffer which stores sampled paths')
parser.add_argument('--batch_size', default=512, type=int)
parser.add_argument('--buffer_device', default='cuda', type=str)
